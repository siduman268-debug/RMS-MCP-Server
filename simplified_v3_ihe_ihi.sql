...
DROP FUNCTION IF EXISTS simplified_inland_function(TEXT, TEXT, TEXT, INTEGER, NUMERIC, TEXT, TEXT);
    ...
    IF v_pol_is_inland AND p_haulage_type = 'carrier' THEN
        BEGIN
            ...
            IF v_haulage_route_record.route_id IS NOT NULL THEN
                ...
                -- Handle null weight ranges - if null, rate applies to all weights
                AND (
