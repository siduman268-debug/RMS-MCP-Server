...
CREATE TABLE lcl_ocean_freight_rate (
    ...
    -- Minimum Charges
    minimum_charge NUMERIC(10,2) DEFAULT 0,              -- Absolute minimum charge (optional, usually only on first slab)
...
-- Only the first slab has a minimum charge (shipment-level minimum)
...
(1, 'INNSA', 'NLRTM', 'CONSOLIDATED', 'SLAB_BASED', 'PER_CBM', 3.0, 5.0, 52.00, 5000, 0, 'USD', 28, '2025-01-01', '2025-12-31', '00000000-0000-0000-0000-000000000001'),
(1, 'INNSA', 'NLRTM', 'CONSOLIDATED', 'SLAB_BASED', 'PER_CBM', 5.0, 8.0, 48.00, 8000, 0, 'USD', 28, '2025-01-01', '2025-12-31', '00000000-0000-0000-0000-000000000001'),
(1, 'INNSA', 'NLRTM', 'CONSOLIDATED', 'SLAB_BASED', 'PER_CBM', 8.0, 12.0, 45.00, 12000, 0, 'USD', 28, '2025-01-01', '2025-12-31', '00000000-0000-0000-0000-000000000001'),
(1, 'INNSA', 'NLRTM', 'CONSOLIDATED', 'SLAB_BASED', 'PER_CBM', 12.0, NULL, 40.00, NULL, 0, 'USD', 28, '2025-01-01', '2025-12-31', '00000000-0000-0000-0000-000000000001'),
...
(2, 'INMUN', 'DEHAM', 'CONSOLIDATED', 'SLAB_BASED', 'PER_CBM', 3.0, 5.0, 50.00, 5000, 0, 'EUR', 25, '2025-01-01', '2025-12-31', '00000000-0000-0000-0000-000000000001'),
(2, 'INMUN', 'DEHAM', 'CONSOLIDATED', 'SLAB_BASED', 'PER_CBM', 5.0, 8.0, 46.00, 8000, 0, 'EUR', 25, '2025-01-01', '2025-12-31', '00000000-0000-0000-0000-000000000001'),
(2, 'INMUN', 'DEHAM', 'CONSOLIDATED', 'SLAB_BASED', 'PER_CBM', 8.0, 12.0, 43.00, 12000, 0, 'EUR', 25, '2025-01-01', '2025-12-31', '00000000-0000-0000-0000-000000000001'),
(2, 'INMUN', 'DEHAM', 'CONSOLIDATED', 'SLAB_BASED', 'PER_CBM', 12.0, NULL, 40.00, NULL, 0, 'EUR', 25, '2025-01-01', '2025-12-31', '00000000-0000-0000-0000-000000000001'),
...
INSERT INTO lcl_surcharge (
    vendor_id, charge_code, applies_scope, rate_basis, amount, percentage, currency, tenant_id
) VALUES
-- Flat amount charges
(1, 'THC_ORIGIN', 'origin', 'PER_CBM', 15.00, NULL, 'USD', '00000000-0000-0000-0000-000000000001'),
(1, 'THC_DEST', 'dest', 'PER_CBM', 18.00, NULL, 'USD', '00000000-0000-0000-0000-000000000001'),
(1, 'DOC_FEE', 'other', 'PER_SHIPMENT', 25.00, NULL, 'USD', '00000000-0000-0000-0000-000000000001'),

-- Percentage-based charges (percentage column must be populated for PERCENTAGE rate_basis)
(1, 'BAF', 'freight', 'PERCENTAGE', 0, 10.00, 'USD', '00000000-0000-0000-0000-000000000001'),
(2, 'CAF', 'freight', 'PERCENTAGE', 0, 5.00, 'EUR', '00000000-0000-0000-0000-000000000001');
